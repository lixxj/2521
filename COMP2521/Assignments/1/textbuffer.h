 ...
 *   of 'tb1'.ay of a handle of type TB. The handle type is declared in the header file, but you will have to provide an implementation of the handle representation - i.e. of struct textbuffer - as part of your implement
 * - The program is to abort() with an error message if 'pos' is out of range.
 */
